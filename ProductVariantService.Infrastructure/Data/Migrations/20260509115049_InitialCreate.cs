        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceAmount = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: true),
                    OldPriceAmount = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantReadModels_IsDefault",
                schema: "product_variant_read",
                table: "ProductVariantReadModels",
                column: "IsDefault");

            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantReadModels_Name",
                schema: "product_variant_read",
                table: "ProductVariantReadModels",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantReadModels_NameNormalized",
                schema: "product_variant_read",
                table: "ProductVariantReadModels",
                column: "NameNormalized");

            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantReadModels_ProductCardId",
                schema: "product_variant_read",
                table: "ProductVariantReadModels",
                column: "ProductCardId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantReadModels_ProductCardId_IsDefault",
                schema: "product_variant_read",
                table: "ProductVariantReadModels",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantReadModels_SKU",
                schema: "product_variant_read",
                table: "ProductVariantReadModels",
                column: "SKU",
                unique: true);
